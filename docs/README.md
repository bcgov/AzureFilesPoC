...
| Daily start / stop workflow | [Daily Startup Runbook](./runbooks/daily-startup.md) |
...
│   ├── daily-startup.md         # Daily startup (start VM + deploy Bastion)
│   ├── daily-shutdown.md        # Daily shutdown (deallocate VM + remove Bastion)
│   ├── scp-file-transfer.md     # SCP via Bastion tunnel file transfer guide
│   ├── vm-shutdown.md           # VM shutdown & cost management (legacy)
...
| [Daily Startup](./runbooks/daily-startup.md) | Start VM, deploy Bastion, quick AI test |
| [Daily Shutdown](./runbooks/daily-shutdown.md) | Deallocate VM and remove Bastion (cost save) |
| [SCP File Transfer](./runbooks/scp-file-transfer.md) | Copy files to VM via Bastion tunnel (SCP) |
